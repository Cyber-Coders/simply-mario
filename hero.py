...
class Hero:  # Персонаж
    def __init__(self, position):
        ...
        self.grounded = True  # переключатель для проверки возможности совершения прыжка - если grounded=False
        self.image = pygame.Surface((25, 34))  # значит игрок находится в воздухе
        pygame.draw.circle(
            self.image,
            (255, 255, 255),
        ...
        # rect - хорошая штука, помогает проверять столкновения с другими объектами, у которых тоже есть rect,
        # ну и координаты хранит
